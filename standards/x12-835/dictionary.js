    ...
    segments: {
      ...
      BPR: {
        ...
        fields: {
          ...
          11: { name: 'Originating Company Supplemental Code', type: 'AN', meaning: 'Extra code the originating company adds for its own routing. Normally empty — a payer that fills it usually shifts everything after it, so check the account numbers below.' },
      ...
      PLB: {
        ...
        fields: {
          ...
          11: { name: 'Adjustment Identifier', type: 'C042' },
          12: { name: 'Provider Adjustment Amount', type: 'AMT' },
          13: { name: 'Adjustment Identifier', type: 'C042' },
          14: { name: 'Provider Adjustment Amount', type: 'AMT' },
        },
      },
    },
